...
def run_daily():
    ...
    evaluation = pd.read_excel(staticfiles_storage.path('NSE/Evaluation.xlsx'),header=0)
        ...
        for sector in sectors:
            for share in sector_symbol_mapping[sector]:
                try:
                    ...
                    pass
        evaluation.to_excel(staticfiles_storage.path('NSE/Evaluation.xlsx'),index=False)
