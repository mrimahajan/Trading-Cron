            ...
            for share in sector_symbol_mapping[sector]:
                ...
                for i in range(1,25):
                    ...
                    for k in range(5,30,5):
                        ...
                        pred.loc[0,f'Bollinger{k}_ratio'] = (pred.loc[0,'Close']-pred.loc[0,f'MA{k}']+2*pred.loc[0,f'Price_Voltality{k}'])/(4*pred.loc[0,f'Price_Voltality{k}'])
                        pred.loc[0,f'Bollinger{k}_volume_ratio'] = (pred.loc[0,'Volume']-pred.loc[0,f'MAV{k}']+2*pred.loc[0,f'Volume_Voltality{k}'])/(4*pred.loc[0,f'Volume_Voltality{k}'])
